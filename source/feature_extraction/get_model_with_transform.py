...
extractor_2_original_transform = {
    ...
    'virchow-v1-cls_token': 'imagenet',
    'virchow-v1-mean_patch_tokens': 'imagenet',
    'virchow-v1-concat': 'imagenet',
    'virchow-v2-cls_token': 'imagenet',
    'virchow-v2-mean_patch_tokens': 'imagenet',
    'virchow-v2-concat': 'imagenet',
    'simclr-tcga-lung_resnet18-2.5x': 'resize_only',
    'simclr-tcga-lung_resnet18-10x': 'resize_only',
    'simclr-camelyon16_resnet18-5x': 'resize_only',
    'simclr-camelyon16_resnet18-20x': 'resize_only',
}
...
def get_feature_extractor(extractor_name):
    ...
    elif extractor_name.startswith('virchow'):
        name_split_list = extractor_name.split("-")
    ...
    # ResNet18 trained with SimCLR on Camelyon16 images (5x magnification):
    elif extractor_name == 'simclr-camelyon16_resnet18-5x':
        feature_extractor = get_resnet18_dsmil(
            weights_path=EXTRACTOR_NAMES_2_WEIGHTS_PATHS[extractor_name])

    # ResNet18 trained with SimCLR on Camelyon16 images (20x magnification):
